...
<div class="main-content" id="div_main">
    ...
    <header class="page-title clearfix">
        <i class="page-name pull-left pointer" onclick="expandTable()"><i id="expand_i" class="fa fa-expand">&nbsp&nbsp פרטים נוספים</i></i>
        <h3 class="page-name pull-right">כל הלקוחות</h3>
    ...
    <section class="all-games table-section">
        @include('customers.customers_table_partial')
    </section>
</div>
